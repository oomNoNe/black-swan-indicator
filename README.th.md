...
โปรเจกต์นี้ออกแบบเป็น **comparative study** เพื่อตอบคำถามวิจัย:

> *"การใช้ news sentiment + ML forecasting + rule-based regime detection
> ให้ผลตอบแทนปรับด้วยความเสี่ยง (risk-adjusted return)
> ดีกว่าการ Buy & Hold หรือไม่?"*

ตามหลัก **5 ขั้นตอนของ statistical inference**:
...
- ⚠️ **ในตลาด bull, กลยุทธ์ defensive แพ้ Buy & Hold** —
  ...
  (sample size ไม่พอสำหรับ formal test)

**Future statistical work**: เพิ่ม Diebold-Mariano test สำหรับ forecast accuracy,
...
โปรเจกต์นี้พัฒนาโดยใช้ **Claude (Anthropic)** เป็น coding assistant
ในทุกขั้นตอน — ตั้งแต่ scaffold โค้ดเริ่มต้น, architecture decisions,
debugging, ไปจนถึงการเขียน documentation
...
1. **Honest** — สิ่งที่เห็นใน repo คือสิ่งที่ทำจริง วิธีที่ทำจริง
...
โค้ดทุกบรรทัด, decision ทุกอย่าง ผ่านการ review, test, และ commit โดยตัวผมเอง
การตัดสินใจ trade-off, การพิจารณาว่า "ship หรือคิดใหม่" — เป็นของผม
